...
- **Description** *(optional)* — one or more `<p>` elements appearing after the heading.
...
|------------------------------------|------------------------------------|------------------------------------|--------------------------------------|
| Open icon *(required)*             | Open label *(required)*            | Close icon *(optional)*            | Close label *(optional)*             |
...
| Navsearch                          |                                       |                                        |
|------------------------------------|---------------------------------------|----------------------------------------|
| Search label *(required)*          | Placeholder text *(required)*         | Submit button text *(required)*        |
